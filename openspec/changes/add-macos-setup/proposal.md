...
- **The menu bar menu gets a Set up permissions… item** while a required permission is missing, next to **Download model…**. This includes a permission that was revoked while the app runs.
...
- `macos-permissions`: the permissions Pisum Transcribe needs on macOS, and how it asks for them and follows them:
  ...
  - the **Set up permissions…** menu item
